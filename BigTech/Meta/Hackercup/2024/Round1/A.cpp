...
void solve(int test_case) {
    ...
    f0r(i, n) {
        // need to arrive at i + 1 seconds time
        double min_speed = (double) (i + 1) / (double) inp[i][1];
        double max_speed = (double) (i + 1) / (double) inp[i][0];
        // DEBUG(i, min_speed, max_speed);
