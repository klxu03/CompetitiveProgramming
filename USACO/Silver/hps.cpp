...
//Problem URL: http://www.usaco.org/index.php?page=viewproblem2&cpid=691
int main() {
    usaco("testCases");
    ...
    /*
        vec[x][0] is # of wins if Bessie chose Paper
        vec[x][1] is # of wins if Bessie chose Hoof
        vec[x][2] is # of wins if Bessie chose Scissors
    */

    //First case
    char firstInput;
    cin >> firstInput;
    if (firstInput == 'P') vec[0][2] = 1;
    if (firstInput == 'H') vec[0][0] = 1;
    if (firstInput == 'S') vec[0][1] = 1;
    ...
    f1r(i, 1, n) {
        ...
        if (input == 'P') {
            ...
            cout << "Input is not a P, H, or a S" << endl;
        }
    }
